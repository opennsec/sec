...
* ***Domain Name System (DNS)***
  ...
  <img src="https://github.com/opennsec/sec/blob/main/module%201/lesson%201%20/img/DNSServers-891f522f2bc2469088df0a11dd687611.jpg" alt="image" width="60%" height="auto">
...
* ***Internet Messaging Program (IMP)***
  ...
  <img src="https://github.com/opennsec/sec/blob/main/module%201/lesson%201%20/img/ec9sv1x6.png" alt="image" width="60%" height="auto">

  ***IMP*** is a web-based email system that allows the upload of data to an existing web server.