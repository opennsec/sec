...
* ***Ethernet***
  ...
  <img src="https://github.com/opennsec/sec/blob/main/module%201/lesson%201%20/img/d7840c6b-54b8-40b5-991a-b94b3eedc789_1.0a6020394257f1402dcf1b226df68a3a.webp" alt="image" width="30%" height="auto"> ***fig. ethernet cable***

  Ethernet is a standardized technology for connecting devices in a ***Local Area Network*** (LAN) or ***Wide Area Network*** (WAN) when with ethernet cables
